...
<div class="layout-content-main">
	<Tabs value="name1" :animated="false" @on-click="Onchange" >
		...
		<TabPane label="控制器" name="ctrList"></TabPane>
		<TabPane label="控制柜" name="cbtList"></TabPane>
		...
		<TabPane label="注册中" name="registing"></TabPane>
     	...
     	<Page style="padding-right: 58%; " class="pagination" show-elevator :total="options.total" :page-size="options.num" :current="options.page" @on-change="pageChange" show-total></Page>
     </div>
     </template>
